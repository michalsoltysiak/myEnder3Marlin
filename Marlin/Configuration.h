...
#define STRING_CONFIG_H_AUTHOR "(MichalMS, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 4.2.7 Michal"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -14, 2 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 45, 50, 45, 50 } // (mm) Left, Front, Right, Back insets
...
#define PREHEAT_1_FAN_SPEED   ((255*6)/10) // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED     80
#define PREHEAT_2_FAN_SPEED   ((255*2)/10) // Value from 0 to 255
