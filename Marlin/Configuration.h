...
#define STRING_CONFIG_H_AUTHOR "(Michal S, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Michal's Ender-3 Pro 4.2.7"
 ...
 */
#define Z_MIN_PROBE_PIN PB1 //v4.2.7
//#define Z_MIN_PROBE_PIN PA7 //v4.2.7
/**
 * Probe Type
 *
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { -44, -14, 2 }/*direct*/
// #define NOZZLE_TO_PROBE_OFFSET { 49, -1, 2 }/*bowden + blockhead*/
#define NOZZLE_TO_PROBE_OFFSET { -40, -1, -3.28 }/*biqu h2*/
...
#define LCD_BED_TRAMMING
  ...
  // bowden - blockhead
  #define BED_TRAMMING_INSET_LFRB { 5, 5, 95, 5 }  // (mm) Left, Front, Right, Back insets
  // direct
  //#define BED_TRAMMING_INSET_LFRB { 45, 23, 45, 23 }
